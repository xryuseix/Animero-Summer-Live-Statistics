...
pub fn make_setlist_2018() -> Result<(), Box<dyn std::error::Error>> {
    // リクエスト
    let body = blocking::get("https://anisama.tv/2018/special/setlist.html")?.text()?;
    // HTMLをパース
    ...
    dump_csv(&setlist, "2018".to_string())?;
